...
export const sampleLinks = [
  {
    ...
    destination_url: 'https://example.com/promotions/summer-sale-2024',
  ...
  },
  {
    ...
    destination_url: 'https://example.com/events/marketing-webinar-registration',
  ...
  },
  {
    ...
    destination_url: 'https://example.com/resources/ultimate-guide-to-utm.pdf',
...
export const sampleContacts = [
  ...
  },
  {
    ...
    tags: ['agency', 'partner'],
    custom_fields: {},
    client_names: ['Digital Agency Co'],
